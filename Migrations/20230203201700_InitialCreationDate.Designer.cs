...
namespace EFProject.Migrations
{
    ...
    [Migration("20230203201700_InitialCreationDate")]
    partial class InitialCreationDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFProject.Models.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 3, 20, 16, 59, 932, DateTimeKind.Utc).AddTicks(1347));
            ...
            modelBuilder.Entity("EFProject.Models.Task", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 3, 20, 16, 59, 932, DateTimeKind.Utc).AddTicks(2515));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("c4e0d0e7-5f06-48c7-9246-11fe12f2c657"),
                            CreationDate = new DateTime(2023, 2, 3, 17, 16, 59, 932, DateTimeKind.Local).AddTicks(830),
                            TaskPriority = 1,
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("c4e0d0e7-5f06-48c7-9246-11fe12f2c602"),
                            CreationDate = new DateTime(2023, 2, 3, 17, 16, 59, 932, DateTimeKind.Local).AddTicks(855),
                            TaskPriority = 0,
